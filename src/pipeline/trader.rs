...
//! - Live trading (Databento feed + IB execution)
//!
//! This module contains no broker-specific code. Execution is handled by:
//! - `ib_execution.rs` for Interactive Brokers order management
//! - `databento_ib_live.rs` for live data + execution integration
